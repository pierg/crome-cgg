    ...
    typeset=Typeset(
        {
            ...
            BooleanLocation(name="lf",
                            description="front", mutex_group="abstract_locs", adjacency_set={"back"}
                            ),
            BooleanLocation(name="lb",
                            description="back", mutex_group="abstract_locs", adjacency_set={"front"}
                            ),
            BooleanLocation(
                name="l1", mutex_group="locations", adjacency_set={"l3", "l2"}, refinement_of={"front"}
            ),
            BooleanLocation(
                name="l2", mutex_group="locations", adjacency_set={"l1", "l4"}, refinement_of={"front"}
            ),
            BooleanLocation(
                name="l3", mutex_group="locations", adjacency_set={"l1", "l4", "l5"}, refinement_of={"front"}
            ),
            BooleanLocation(
                name="l4", mutex_group="locations", adjacency_set={"l3", "l2"}, refinement_of={"front"}
            ),
            BooleanLocation(
                name="l5", mutex_group="locations", adjacency_set={"l3"}, refinement_of={"back"}
            ),
            BooleanLocation(
